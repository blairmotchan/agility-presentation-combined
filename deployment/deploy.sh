...
ssh -i id_rsa_ab7c42aebeba55bc1d50f35b575e2325 'java -jar agility-attendee-sessions/target/agility-attendee-session.jar >> agility-attendee.log & java -jar agility-combined/target/agility-combined.jar >> agility-combined.log & java -jar agility-registration/target/agility-registration.jar >> agility-registration.log'
